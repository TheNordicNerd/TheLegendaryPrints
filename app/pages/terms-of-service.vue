<template>
  <Section>
    <SectionHeader title="Terms of service" title-size="lg" class="py-24" />
    <div class="max-w-3xl mx-auto">
      <h2>OVERVIEW</h2>
      <p class="inner-p">
        This website is operated by The Legendary Prints. Throughout the site, the terms “we”, “us”
        and “our” refer to Legendary Prints. Legendary Prints offers this website, including all
      ...
      <p class="inner-p">Prices for our products are subject to change without notice.</p>
      ...
      <p class="inner-p">
        ...
        according to our Refund Policy: [LINK TO REFUND POLICY]
      </p>
      <p class="inner-p">
      ...
      <p>
        ...
        Service. You agree that your comments will not violate any right of any third-party,
      ...
      <p>
        ...
        particular purpose, durability, title, and non-infringement. In no case shall Legendary
        Prints, our directors, officers, employees, affiliates, agents, contractors, interns,
      ...
      <p>
        You agree to indemnify, defend and hold harmless Legendary Prints and our parent,
      ...
      <p class="inner-p">
        ...
        and governs your use of the Service, superseding any prior or contemporaneous agreements,
      ...
      <p>
        Questions about the Terms of Service should be sent to us at support@thelegendaryprints.com.
      </p>
    </div>
  </Section>
</template>
